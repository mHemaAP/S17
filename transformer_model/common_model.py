...
from transformer_model.models.vit.vit_components import PatchEmbedding, TransformerEncoderBlock
...
class MultiHeadAttention(nn.Module):
    def __init__(self, n_heads, out_dim = None,
                 block_size = None, head_size = None,
                 num_embed = None, dropout = 0.1, algorithm = "BERT"):
        super().__init__()
        self.dropout = nn.Dropout(dropout)
...
class FeedForward(nn.Module):
    def __init__(self, inp_dim = None, inner_dim = None, 
                 num_embed = None, dropout = 0.1, algorithm = "BERT"):
        super().__init__()
        self.algorithm = algorithm
        if self.algorithm == "BERT":
...
class EncoderLayer(nn.Module):
    def __init__(self, n_heads, inner_transformer_size, 
                 inner_ff_size, dropout=0.1):
        super().__init__()
        # n_heads, out_dim=None,block_size=None, head_size=None,num_embed=None,dropout=0.1,algorithm="BERT")
        self.mha = MultiHeadAttention(n_heads = n_heads, out_dim = inner_transformer_size,
                                      block_size = None, head_size = None,
                                      num_embed = None, dropout = dropout, algorithm = "BERT")
        # (self, inp_dim=None, inner_dim=None,num_embed=None, dropout=0.1,algorithm="BERT")
        # inp_dim, inner_dim, dropout=0.1)
        self.ff = FeedForward(inp_dim = inner_transformer_size, 
                              inner_dim = inner_ff_size,
                              num_embed = None, 
                              dropout = dropout,
                              algorithm = "BERT")
...
class TransformerBlock(nn.Module):
    ...
    def __init__(self, num_heads, block_size, num_embed, dropout):
        ...
        self.ffwd = FeedForward(inp_dim = None, inner_dim = None,
                                num_embed = num_embed, dropout = dropout,
                                algorithm = "GPT")
...
class Transformer(nn.Module):
    def __init__(self, n_code=None,
                 ...
                 seq_len=None,
                 vocab_size=100, 
                 # Training resolution from Table 3 in ViT paper
                 img_size:int=224,
                 ...
                 mlp_size:int=3072,
                 # Dropout for attention projection 
                 attn_dropout:float=0,
                 # Dropout for dense/MLP layers 
