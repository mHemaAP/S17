...
from models.bert.bert_components import PositionalEmbedding, EncoderLayer
from models.gpt.gpt_components import TransformerBlock
from models.vit.vit_components import PatchEmbedding, TransformerEncoderBlock

# Bert Transformer
class BertTransformer(nn.Module):
    def __init__(self, n_code, n_heads, 
                embed_size, inner_ff_size, 
                n_embeddings, seq_len, dropout=0.1):
        super().__init__()
...
class ViTTransformer(nn.Module):
    ...
    def __init__(self,
                 ...
                 # Patch size 
                 patch_size:int=16,
                 # Layers from Table 1 for ViT-Base 
        ...
        # 9. Create Transformer Encoder blocks (we can stack Transformer Encoder blocks 
        # using nn.Sequential()) 
        # Note: The "*" means "all"
